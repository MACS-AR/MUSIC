...
from MusicMacs.helpers.queues import QUEUE, add_to_queue, get_queue, clear_queue
from MusicMacs.helpers.decorators import authorized_users_only
from MusicMacs.helpers.handlers import skip_current_song, skip_item
from pyrogram.errors import FloodWait, MessageNotModified
from youtubesearchpython import SearchVideos
from yt_dlp import YoutubeDL
from MusicMacs.helpers.merrors import capture_err
    ...
    if replied:
        if replied.audio or replied.voice:
            ...
            if chat_id in QUEUE:
                ...
                await m.reply_photo(
                    photo="https://telegra.ph/file/e4b35c210743a74277fef.jpg",
                    caption=f"""
